...
from common import DATA_PATH, append_transaction, file_signature, load_data

st.set_page_config(page_title="Spending Dashboard - Overview", page_icon="💷", layout="wide")
...
st.sidebar.caption("Overview — see **Budget vs Actual** in the page nav above for how you're tracking against budget.")
